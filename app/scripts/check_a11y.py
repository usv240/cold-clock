...
checks = {
    ...
    "dialogs have accessible names": all(token in landing for token in ('aria-labelledby="intake-title"', 'aria-labelledby="sensor-title"', 'aria-labelledby="review-title"')),
    "skip link exists": "skip-link" in landing,
    "theme control is a button": '<button class="theme-toggle"' in landing,
