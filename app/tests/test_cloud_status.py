...
def test_health_exposes_truthful_google_service_inventory():
    ...
    assert {"Gemini 3.5 Flash on Vertex AI", "Google Gen AI SDK", "Google ADK", "Pub/Sub", "Gemma 4 on Vertex AI", "Cloud Run", "Firestore", "Cloud Scheduler", "Cloud Trace"} <= services
